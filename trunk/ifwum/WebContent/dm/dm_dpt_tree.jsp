...
<!-- %@ include file="ifwum_left.jsp" %-->
    ...
    <p><br>机构树如下，可在此基础上维护机构信息，创建部门后还可以点击 <a href="javascript:parent.dpttree.submit();">这里</a> 刷新机构树。<br></p>
...
<ium:tree provider="com.css.security.db.org.DeptTreeNodeProvider" linkUrl="#" rootText="组织机构树"/>
